# -*- coding: utf-8 -*-
"""
Created on Wed Mar 22 14:36:06 2023
...
import time
root = Tk()
root.title("Foriegn Timings Project")
...
australia_clock.place(relx = 0.2, rely = 0.7, anchor = CENTER)

australia_time = Label(root)
australia_time.place(relx = 0.2, rely = 0.9, anchor = CENTER)
...
japan_clock.place(relx = 0.7, rely = 0.7, anchor = CENTER)

japan_time = Label(root)
japan_time.place(relx = 0.7, rely = 0.9, anchor = CENTER)
...
australia_btn.place(relx=0.2,rely=0.95, anchor= CENTER) 
japan_btn=Button(root,text="Show Time",command=obj_japan.times) 
japan_btn.place(relx=0.7,rely=0.95, anchor= CENTER) 
